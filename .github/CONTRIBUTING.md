...
Fork, then clone the repo:
    ...
    git clone git@github.com:your-username/bitly-shortener.git

**All changes should be based from the `main` branch.**

Push to your fork and [submit a pull request](https://github.com/builders-club/bitly-shortener/compare/) against the `main` branch.
